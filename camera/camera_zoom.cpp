...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		//angle = 5*(GLfloat)glfwGetTime();
		cameraPos = glm::vec3(distance * sin(-glm::radians(angle)),
							  0.f,
							  -distance * cos(-glm::radians(angle)));

		glm::mat4 view = glm::lookAt(center-cameraPos,
									 cameraPos,
									 cameraUp);
		
        // glm::mat4 view = glm::lookAt(cameraPos - cameraFront,
		// 							cameraPos,
		// 							cameraUp);
        // Projection 
        glm::mat4 projection = glm::perspective(aspect,
